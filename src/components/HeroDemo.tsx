...
export function HeroDemo() {
  const [activeId, setActiveId] = useState<HeroJobId>("sales-outbound");
  const activeJob =
    ...
    <section className="hero" aria-labelledby="hero-heading">
          ...
          {HERO_JOBS.map((job) => {
            ...
            return (
              <button
                ...
                aria-controls="hero-phone-panel"
      ...
      >
        <div className="hero-phone">
          ...
          <div className="hero-phone-thread" key={activeJob.id}>
